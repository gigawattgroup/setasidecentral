...
function sac_setup() {
	...
	/*add_theme_support( 'custom-background', apply_filters( 'sac_custom_background_args', array(
 ...
 */
function sac_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'sac_content_width', 640 );
}
add_action( 'after_setup_theme', 'sac_content_width', 0 );
 ...
 */
function sac_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'sac' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'sac' ),
...
add_action( 'widgets_init', 'sac_widgets_init' );
...
function sac_scripts() {
	...
	wp_enqueue_style( 'polyfill-objectfit',  get_template_directory_uri() . '/css/polyfill.object-fit.css', array(), '0.3.4' );
